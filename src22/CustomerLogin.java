...
public CustomerLogin() {
    ...
    private void initialize() {
        ...
        JLabel lblWelcome = new JLabel("Welcome To Chilema");
        lblWelcome.setForeground(Color.ORANGE);
        lblWelcome.setBounds(150, 21, 235, 50);
        ...
        btnForget.setBounds(160, 230, 150, 22);
        Customer.getContentPane().add(btnForget);
